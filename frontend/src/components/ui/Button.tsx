...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    ...
    outline: 'bg-transparent hover:bg-slate-800 text-slate-300 border border-slate-600 hover:border-slate-500 focus:ring-blue-500',
    danger: 'bg-red-600 hover:bg-red-500 text-white shadow-lg shadow-red-600/20 focus:ring-red-500 active:scale-[0.98]',
